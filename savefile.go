...
func (a *SaveFileAPI) GoAddNewCard(patchJson service.PartialCard, savefileLocation string, deckJsonPath string) (string, error) {
...
func (a *SaveFileAPI) GoGetDirectory(path string) (*service.DirectoryResponse, error) {
...
func (a *SaveFileAPI) GoGetEntries(path string) (*service.DirectoryResponse, error) {
	return service.GetEntries(path)
}
